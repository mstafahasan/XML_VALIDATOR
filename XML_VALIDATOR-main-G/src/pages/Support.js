        ...
        >
          ...
          <HelpGrid>
            <HelpCard>
              ...
              <HelpButton onClick={() => window.open('https://github.com/Gaserzaghloul/XML_VALIDATOR/blob/main/README.md', '_blank')}>
                View Documentation
              </HelpButton>
            </HelpCard>
            ...
            <HelpCard>
              ...
              <HelpButton onClick={() => window.open('https://github.com/Gaserzaghloul/XML_VALIDATOR', '_blank')}>
                Browse Code
              </HelpButton>
            </HelpCard>
